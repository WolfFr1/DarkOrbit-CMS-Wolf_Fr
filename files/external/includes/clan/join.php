<ul class="button-container">
  <li><a class="horizontal-button" href="<?php echo DOMAIN; ?>clan/found">Found</a></li>
  <li><a class="horizontal-button" href="<?php echo DOMAIN; ?>clan/join">Join</a></li>
</ul>
<?php
$clans_per_page = 10;
...
<div class="card white-text grey darken-4 col s12 padding-15">
  <div class="row">
  <h4 style="color: orange;">Clan Search</h4>
