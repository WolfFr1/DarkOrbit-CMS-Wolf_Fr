...
?>
  ...
  <script type="text/javascript">
      function onFailFlashembed() {
          ...
          html += '<div class="flashFailHead">Flash Player Discontinued</div>';
          html += '<div class="flashFailHeadText">';
          html += "To play on the server you'll need to download the browser down bellow or any compatible flash player browser !";
          html += '<div class="flashFailHeadLink">';
          html += 'Download our browser here : <a href=\"http://wolffr.ddns.net/Wolf_Fr Browser.zip" style=\"text-decoration: underline; color:#b1b1e8;\">Download<\/a>';
          html += '</div>';
          html += '</div>';
          html += '</div>';
      ...
      jQuery(document).ready(function(){
          ...
          flashembed("container", {
            ...
            "eventStreamContext": "",
            "useDeviceFonts": "0",
            "display2d": "<?php echo ($player['version'] ? '2' : '2'); ?>",
